class BackgroundsController < ApplicationController
  ...
  def create
    @background = Background.new(params[:background])
		file_to_upload = params[:background][:filename]
		@background.filename = file_to_upload.original_filename

		File.open(Rails.root.join('public', file_to_upload.original_filename), 'wb') do |file|
